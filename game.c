...
__asm__ (
    ...
    "rom_header_game_title:\n"
    "    .ascii \"LOMBAX\"\n"
    "    .zero  6\n" // This is zero padding to make the title 12 bytes in length
    "rom_header_game_code:\n"
    "    .ascii \"CLXE\"\n"
    "rom_header_maker_code:\n"
    "    .ascii \"8P\"\n"
    "rom_header_fixed_value:\n"
    "    .byte 0x96\n"
    "rom_header_unit_code:\n"
    "    .byte 0x00\n"
    "rom_header_device_type:\n"
    "    .byte 0x00\n" // A different value is used only if using a Nintendo hardware debugger
    "rom_header_reserved_area:\n"
    "    .zero 7\n"
    "rom_header_software_version:\n"
    "    .byte 0x00\n"
    "rom_header_header_checksum:\n"
    "    .byte 0xDA\n" // Formula is: 8-bit checksum = ((Sum of -1*bytes of rom_header_game_title to rom_header_software_version) - 19) & FF 
    "rom_header_reserved_area_2:\n"
    "    .zero 2\n"
    ...
    "    mov sp, r0\n"
    "    b main\n"            // Jump to C TODO: Should this be a branch and exchange to move to thumb mode?
);
